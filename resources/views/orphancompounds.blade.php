    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                {{ __("Search by date:") }}
                    <form action="{{ route('report.orphancompoundResult') }}" method="POST">
                    {{ csrf_field() }}
                        <table class="table">
                            <tr>
                                <td>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <table>
                        <thead>
                            <tr>
                            <th>Orphan pure compounds - source IDs have not been added as extracts or fractions</th>
                            <th>&nbsp;</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                            @foreach (array_keys(json_decode(json_encode($result_compounds[0]), true)) as $colnameArr => $colname)
                            ...
                            @foreach ($result_compounds as $result)
                                <tr>
                ...
                <div>
                    <form action="{{ route('exportOrphanCompounds') }}" method="POST" target= "__blank">
                        @csrf
                    <div class="form-group">
                        ...
                        <div class="col-sm-offset-3 col-sm-6">
                            <button type="submit" class="editBtn" id="mybutton">
                                <i class="fa fa-plus"></i> Export Orphan Compounds
                            </button>
                        </div>
                    </div>
                    </form>
